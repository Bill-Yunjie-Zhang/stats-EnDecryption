...
const successfulEncryption = (txt, key) => {
    ...
    if (checkEncryptionQuality(cipher) < 10) {
        ...
        return "the key is not safe enough"
    }
}
...
let key = "caajdfhvbalewihglanhocwikhnqasihqalewugbalinlrgoqwaedsvujbliudjvpqazmzdfin"

console.log(successfulEncryption(text, key))